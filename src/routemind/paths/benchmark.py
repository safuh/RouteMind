...
def run_benchmark(name: str) -> BenchmarkResult:
    ...
    engine = PathSearchEngine(
        options,
        PathSearchConfig(remove_dominated=False, max_candidates=20),
    )
...
def run_all_benchmarks() -> list[BenchmarkResult]:
    names = (
        "cheapest_route",
        "fastest_route",
        "deadline_eliminates_cheap",
        "capacity_eliminates_direct",
        "multimodal_beats_direct",
        "reliability_tradeoff",
        "transfer_cost_tradeoff",
        "no_feasible_route",
    )
...
def _base() -> tuple[Location, Location, Location, datetime, Shipment]:
    ...
    shipment = Shipment(
        ...
        ready_at=ready,
        deadline=ready + timedelta(hours=24),
    )
...
def _cheapest_route():
    n, _, e, t, s = _base()
    options = [_option("CHEAP", n, e, t, 8, "500"), _option("EXP", n, e, t, 5, "1000")]
    return options, s


def _fastest_route():
    n, _, e, t, s = _base()
    options = [_option("SLOW", n, e, t, 8, "500"), _option("FAST", n, e, t, 5, "1000")]
    return options, s
...
def _deadline_eliminates_cheap():
    ...
    options = [_option("CHEAP", n, e, t, 8, "500"), _option("FAST", n, e, t, 5, "1000")]
    return options, s
...
def _capacity_eliminates_direct():
    ...
    options = [
        ...
        _option("N-K", n, k, t, 3, "300"),
        _option("K-E", k, e, t + timedelta(hours=4), 3, "300"),
    ]
    return options, s
...
def _multimodal_beats_direct():
    ...
    options = [
        ...
        _option("N-K", n, k, t, 3, "300"),
        _option("K-E", k, e, t + timedelta(hours=3), 3, "300"),
    ]
    return options, s
...
def _reliability_tradeoff():
    ...
    options = [
        ...
        _option("RELIABLE", n, e, t, 7, "700", reliability=0.99),
    ]
    return options, s
...
def _transfer_cost_tradeoff():
    ...
    options = [
        ...
        _option("N-K", n, k, t, 2, "300"),
        _option("K-E", k, e, t + timedelta(hours=2), 2, "300"),
    ]
    return options, s
...
def _no_feasible_route():
    n, _, e, t, s = _base()
    options = [_option("TOO_SMALL", n, e, t, 4, "300", weight=5)]
    return options, s
